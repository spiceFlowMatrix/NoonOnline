...
public class VideoInfo implements Parcelable {
    ...
    public VideoInfo(VideoInfo defaultVideoInfo) {
        ...
        subTitle = defaultVideoInfo.subTitle;
        username = defaultVideoInfo.username;
    ...
    public VideoInfo setSubTitle(String subTitle) {
        this.subTitle = subTitle;
        return this;
    }

    public VideoInfo setusername(String username) {
