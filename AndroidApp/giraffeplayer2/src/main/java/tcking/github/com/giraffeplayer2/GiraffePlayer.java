...
public class GiraffePlayer implements MediaController.MediaPlayerControl {
    ...
    // Internal messages
    public static final int MSG_CTRL_PLAYING = 1;
    ...
    public GiraffePlayer(final Context context, final VideoInfo videoInfo) {
...
//                int videoSarDen = mp.getVideoSarDen();
    ...
    public GiraffePlayer setDisplayModel(int targetDisplayModel) {
        ...
        if (targetDisplayModel == DISPLAY_FULL_WINDOW) {
            ...
            //Log.e("CONSTTTTT", "=====33333====" + targetDisplayModel);

            Activity activity = getActivity();
            if (activity == null) {

                //Log.e("CONSTTTTT", "=====44444====" + targetDisplayModel);
                return this;
            }
           ...
           /* UIHelper uiHelper = UIHelper.with(activity);
            if (videoInfo.isPortraitWhenFullScreen()) {
                ...
                Log.e("CONSTTTTT", "=====5555555====" + targetDisplayModel);
            }
            ...
            //Log.e("CONSTTTTT", "=====666666====" + targetDisplayModel);

            final Activity activity = getActivity();
            if (activity == null) {

                //Log.e("CONSTTTTT", "=====777777====" + targetDisplayModel);
                return this;
            }
            final VideoView videoView = PlayerManager.getInstance().getVideoView(videoInfo);
            if (videoView == null) {

                //Log.e("CONSTTTTT", "=====8888888====" + targetDisplayModel);
                return this;
            }
            //change orientation & action bar
           /* UIHelper uiHelper = UIHelper.with(activity);
            if (videoInfo.isPortraitWhenFullScreen()) {
                Log.e("CONSTTTTT", "=====999999====" + targetDisplayModel);
                uiHelper.requestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
