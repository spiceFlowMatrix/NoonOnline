...
public class AssignmentFileUploadListAdapter extends RecyclerView.Adapter<AssignmentFileUploadListAdapter.MyViewHolder> implements DroidListener {
    ...
    public AssignmentFileUploadListAdapter() {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        DiscussionsFileUploadItemLayoutBinding itemViewBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.discussions_file_upload_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.discussionsFileUploadItemLayoutBinding.imgDiscussionsClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AssignmentAddActivity.fileUploadList.remove(position);
