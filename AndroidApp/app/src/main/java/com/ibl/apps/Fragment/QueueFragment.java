...
import com.ibl.apps.noon.databinding.FragmentQueueBinding;
...
public class QueueFragment extends BaseFragment {
    ...
    protected void setUp(View view) {
        ...
        binding.rvInqueue.rcVertical.setLayoutManager(linearLayoutManager);
        ...
        binding.rvInqueue.rcVertical.addOnScrollListener(scrollListener);
    }
                    ...
                    public void onSuccess(FeebBackTask feebBackTask) {
                        if (feebBackTask != null) {
                            if (feebBackTask.getData() != null && !feebBackTask.getData().isEmpty()) {
                                binding.rvInqueue.rcVertical.setVisibility(View.VISIBLE);
                                ...
                                binding.rvInqueue.rcVertical.setAdapter(adapter);
                                ...
                                if (feebBackTaskdata.size() == 0) {
                                    binding.rvInqueue.rcVertical.setVisibility(View.GONE);
