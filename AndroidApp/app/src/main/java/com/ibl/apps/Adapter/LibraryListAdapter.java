...
import com.ibl.apps.noon.databinding.LibraryListLayoutBinding;
...
public class LibraryListAdapter extends RecyclerView.Adapter<LibraryListAdapter.MyViewHolder> implements Filterable, DroidListener {

    List<LibraryObject.Data> list;
    List<LibraryObject.Data> ListFiltered;
    Context ctx;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        LibraryListLayoutBinding libraryListLayoutBinding;

        public MyViewHolder(LibraryListLayoutBinding itemhistorylayoutBinding) {
            super(itemhistorylayoutBinding.getRoot());
            this.libraryListLayoutBinding = itemhistorylayoutBinding;
        }
    }

    public LibraryListAdapter(Context ctx, List<LibraryObject.Data> list, UserDetails userDetailsObject) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LibraryListLayoutBinding itemViewBinding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.getContext()),
                R.layout.library_list_layout, parent, false);
        return new MyViewHolder(itemViewBinding);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        LibraryObject.Data model = ListFiltered.get(position);
        ...
        if (!TextUtils.isEmpty(model.getTitle())) {
            holder.libraryListLayoutBinding.txtBookName.setText(model.getTitle());
        }

        if (!TextUtils.isEmpty(model.getAuthor())) {
            holder.libraryListLayoutBinding.txtBookDesc.setText(model.getAuthor());
        }
        ...
        if (isNetworkAvailable(ctx)) {
            GlideApp.with(ctx)
                    ...
                    .dontAnimate()
                    .fitCenter()
                    .into(holder.libraryListLayoutBinding.mainBookImage);

            holder.libraryListLayoutBinding.mainImageBookLay.setVisibility(View.GONE);
            holder.libraryListLayoutBinding.mainBookListLay.setClickable(true);

        } else {

            GlideApp.with(ctx)
                    .asBitmap()
                    .load(model.getBookcoverImageBitmap())
                    .placeholder(R.drawable.ic_no_image_found)
                    .error(R.drawable.ic_no_image_found)
                    .fitCenter()
                    .into(holder.libraryListLayoutBinding.mainBookImage);
            ...
            try {
                ...
                if (model.getFile().getId() != null) {
                    ...
                    if (file.exists()) {
                        ...
                        holder.libraryListLayoutBinding.mainImageBookLay.setVisibility(View.VISIBLE);
                        holder.libraryListLayoutBinding.mainBookListLay.setClickable(false);
                    }
                }
        ...
        holder.libraryListLayoutBinding.mainBookListLay.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.libraryListLayoutBinding.mainImageBookLay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<LibraryObject.Data> filteredList = new ArrayList<>();
                    for (LibraryObject.Data row : list) {
                        if (row.getTitle().toLowerCase().contains(charString.toLowerCase()) ||
                                ...
                                row.getBookpublisher().toLowerCase().contains(charString.toLowerCase())) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ListFiltered = (ArrayList<LibraryObject.Data>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }

    public void callApifetchSignedUrl(String fileID, String lessionID, MyViewHolder holder, LibraryObject.Data model) {
    ...
    public class DownloadStatusTask extends AsyncTask<String, String, String> {
        ...
        String fileURL;
        MyViewHolder holder;
        LibraryObject.Data model;
        int downloadId = 0;
        long progressval = 0;
        Context context;

        public DownloadStatusTask(Context context, String fileURL, MyViewHolder holder, LibraryObject.Data model) {
...
//                                            mProgressDialog.dismiss();
    ...
    public void openDialogViewer(Context context, String pdffileURI, LibraryObject.Data model) {
