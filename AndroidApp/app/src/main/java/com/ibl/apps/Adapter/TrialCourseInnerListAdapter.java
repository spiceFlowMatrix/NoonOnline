...
import com.ibl.apps.noon.TrialChapterActivity;
import com.ibl.apps.noon.databinding.TrialCourseInnerLayoutBinding;
...
public class TrialCourseInnerListAdapter extends RecyclerView.Adapter<TrialCourseInnerListAdapter.MyViewHolder> implements DroidListener {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TrialCourseInnerLayoutBinding courseInnerLayoutBinding;

        public MyViewHolder(TrialCourseInnerLayoutBinding itemhistorylayoutBinding) {
            super(itemhistorylayoutBinding.getRoot());
            this.courseInnerLayoutBinding = itemhistorylayoutBinding;
        }
    }

    public TrialCourseInnerListAdapter(Context ctx, List<CourseObject.Courses> list, UserDetails userDetailsObject) {
        this.list = list;
        this.ctx = ctx;
    ...
    public TrialCourseInnerListAdapter(Context ctx) {
        this.ctx = ctx;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        TrialCourseInnerLayoutBinding itemViewBinding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.getContext()),
                R.layout.trial_course_inner_layout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.courseInnerLayoutBinding.mainInnerCoursLAy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ctx, TrialChapterActivity.class);
                ctx.startActivity(i);
